...
export async function POST(
  ...
  await db.auditLog.create({
    data: {
      ...
      action: "UNIT_APPROVE",
      detail: `Approved "${unit.unitName}" (${unit.grade.displayName}/${unit.subject.name})`,
    },
  });
  await db.notification.create({
    data: {
      ...
      title: "Unit Approved",
      message: `Your unit "${unit.unitName}" (${unit.grade.displayName} / ${unit.subject.name} / ${unit.term}) has been approved.`,
    },
  });
